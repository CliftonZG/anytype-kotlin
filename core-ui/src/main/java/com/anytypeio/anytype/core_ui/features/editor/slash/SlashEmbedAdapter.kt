...
import com.anytypeio.anytype.core_ui.features.editor.slash.holders.EmbedMenuHolder
import com.anytypeio.anytype.core_ui.features.editor.slash.holders.SubheaderMenuHolder
import com.anytypeio.anytype.presentation.editor.editor.slash.SlashItem

class SlashEmbedAdapter(
    ...
    override fun createHolder(
        ...
        parent: ViewGroup,
        viewType: Int
    ): RecyclerView.ViewHolder = EmbedMenuHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is EmbedMenuHolder -> {
                val item = items[position] as SlashItem.Embed
                holder.bind(item)
            }
    ...
    override fun getItemViewType(position: Int): Int = when (val item = items[position]) {
        is SlashItem.Embed -> R.layout.item_slash_widget_style
